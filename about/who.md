...
Подать заявление можно [тут](https://www.maii.li/discipline) (также форма есть в меню сайта МАИИ), связаться с группой — по этому адресу: <dg@maii.li>, также вопросы о работе группы можно задать в канале [«Вопросы дисциплинарная»](https://discord.gg/hDZkkTJwVa) сервера МАИИ в Дискорде.
